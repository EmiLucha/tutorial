...
import com.ccsw.tutorial.client.service.ClientServiceImpl;
...
public class ClientTest {
    ...
    public static final String CLIENT_NAME = "FULANITO";
    ...
    @Test
    public void saveClientWithNameAlreadyUsedShouldThrowException() {

        ClientDto clientDto = new ClientDto();
        clientDto.setName(CLIENT_NAME);

        ClientDto clientDto2 = new ClientDto();
        clientDto2.setName(CLIENT_NAME);

        when(clientRepository.existsByName(CLIENT_NAME)).thenReturn(false).thenReturn(true);

        clientService.save(null, clientDto);

        assertThrows(DuplicateNameException.class, () -> clientService.save(null, clientDto2));
    }
